...
| [Safeguard Finance System](https://github.com/jonasqasoftware/safeguard-finance-system) | Security-focused transactional API lab with threat modeling, defensive controls, and executable negative tests. |
